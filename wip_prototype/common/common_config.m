...
%                dual-UAV capability degradation and BDTR benchmark parameters.
%
...
% ----------------------------------------------------------------------
% Capability-change events: Dual-UAV degradation without total fleet failure
% Event 1: UAV1 loses Thermal at t = 20s (retains Camera)
% Event 2: UAV3 loses LiDAR at t = 35s   (retains Camera)
% ----------------------------------------------------------------------
...
cfg.cost.refQueueLen       = ceil(numel(cfg.task) / numel(cfg.uav)); % 3 tasks/UAV
