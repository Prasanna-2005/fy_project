%% MAIN  Reactive Hungarian (LAP + Preemption)
% Configures scenario parameters via common_config and executes Reactive Hungarian simulation.
...
result = sim(cfg, 'reactive');

fprintf('\n=== Reactive Hungarian — Result ===\n');
fprintf('%-22s %8s\n', 'Metric', 'Value');
m = result.metrics;
